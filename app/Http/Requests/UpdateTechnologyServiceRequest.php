...
class UpdateTechnologyServiceRequest extends FormRequest
{
    use PhotoRules;
    ...
    public function authorize(): bool
    {
        if ($this->user()->can('technologyServices.evaluations.store')) {
            return in_array($this->input('technology_service_status_id'), [1, 3, 4]);
        }

        return in_array($this->input('technology_service_status_id'), [1, 2, 4]);
    }
