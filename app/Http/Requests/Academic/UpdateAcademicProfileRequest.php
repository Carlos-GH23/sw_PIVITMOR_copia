...
class UpdateAcademicProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        ], $this->contactRules(), $this->phoneNumberRules(), $this->socialLinkRules(), $this->locationRules());
    }

    public function attributes(): array
    {
        return array_merge([
            'photo.file'                => 'foto de perfil',
            'first_name'                => 'nombre',
            ...
            'knowledge_lines'           => 'palabras clave',
            'knowledge_lines.*name'     => 'palabra clave',
            ...
            'sni.end_date'          => 'fecha fin SNII',

            'profile.has_profile'       => 'perfil deseable',
            'profile.start_date'        => 'fecha de inicio del perfil deseable',
            'profile.end_date'          => 'fecha fin del perfil deseable',
