...
class StoreConferenceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return array_merge([
            ...
            'modality' => ['required_if:conference_status_id,2', 'nullable', 'string', 'in:Presencial,Virtual,Híbrido'],
            'language_id' => ['required_if:conference_status_id,2', 'nullable', 'integer', 'exists:languages,id'],
            'start_date' => ['required_if:conference_status_id,2', 'nullable', 'date'],
            'end_date' => ['required_if:conference_status_id,2', 'nullable', 'date', 'after_or_equal:start_date'],
            'technical_requirements' => ['nullable', 'string', 'max:2000'],
            'department_id' => ['required_if:conference_status_id,2', 'nullable', 'integer', 'exists:departments,id'],
            'academics' => ['required_if:conference_status_id,2', 'array'],
            'academics.*' => ['integer', 'exists:academics,id'],
            'oecd_sectors' => ['required_if:conference_status_id,2', 'array'],
            ...
            'keywords' => ['required_if:conference_status_id,2', 'array', 'max:5'],
