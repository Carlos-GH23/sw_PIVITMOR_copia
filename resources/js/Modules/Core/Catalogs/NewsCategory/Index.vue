<template>
    ...
    <LayoutMain>
        ...
        <SearchBar @apply-filters="applyFilters" @clear-filters="clearFilters" v-model:search="filters.search"
            v-model:rows="filters.rows" :routeName="routeName" title="área" :total="newsCategories.meta.total" />
        <CardBox v-if="newsCategories.data.length > 0">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr v-for="item in newsCategories.data" :key="item.id">
        ...
        <pagination :links="newsCategories.meta.links" :total="newsCategories.meta.total" :to="newsCategories.meta.to"
            :from="newsCategories.meta.from" />
    </LayoutMain>
</template>
<script setup>
