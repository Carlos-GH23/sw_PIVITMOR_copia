<template>
    ...
    <LayoutMain>
        ...
        <SearchBar @apply-filters="applyFilters" @clear-filters="clearFilters" v-model:search="filters.search"
            v-model:rows="filters.rows" :routeName="routeName" title="área" :total="educationalModalities.meta.total" />
        <CardBox v-if="educationalModalities.data.length > 0">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr v-for="item in educationalModalities.data" :key="item.id">
        ...
        <pagination :links="educationalModalities.meta.links" :total="educationalModalities.meta.total"
            :to="educationalModalities.meta.to" :from="educationalModalities.meta.from" />
    </LayoutMain>
</template>
<script setup>
