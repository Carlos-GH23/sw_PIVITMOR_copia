<template>
    ...
    <LayoutMain>
        ...
        <SearchBar @apply-filters="applyFilters" @clear-filters="clearFilters" v-model:search="filters.search"
            v-model:rows="filters.rows" :routeName="routeName" title="área" :total="educationalLevels.meta.total" />
        <CardBox v-if="educationalLevels.data.length > 0">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr v-for="item in educationalLevels.data" :key="item.id">
        ...
        <pagination :links="educationalLevels.meta.links" :total="educationalLevels.meta.total"
            :to="educationalLevels.meta.to" :from="educationalLevels.meta.from" />
    </LayoutMain>
</template>
<script setup>
