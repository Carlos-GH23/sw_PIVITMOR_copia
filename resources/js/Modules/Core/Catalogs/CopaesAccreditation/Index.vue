<template>
    ...
    <LayoutMain>
        ...
        <SearchBar @apply-filters="applyFilters" @clear-filters="clearFilters" v-model:search="filters.search"
            v-model:rows="filters.rows" :routeName="routeName" title="área" :total="copaesAccreditations.meta.total" />
        <CardBox v-if="copaesAccreditations.data.length > 0">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr v-for="item in copaesAccreditations.data" :key="item.id">
        ...
        <pagination :links="copaesAccreditations.meta.links" :total="copaesAccreditations.meta.total" :to="copaesAccreditations.meta.to"
            :from="copaesAccreditations.meta.from" />
    </LayoutMain>
</template>
<script setup>
