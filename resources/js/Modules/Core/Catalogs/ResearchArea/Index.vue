<template>
    ...
    <LayoutMain>
        ...
        <SearchBar @apply-filters="applyFilters" @clear-filters="clearFilters" v-model:search="filters.search"
            v-model:rows="filters.rows" :routeName="routeName" title="área" :total="researchAreas.meta.total" />
        <CardBox v-if="researchAreas.data.length > 0">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr v-for="item in researchAreas.data" :key="item.id">
        ...
        <pagination :links="researchAreas.meta.links" :total="researchAreas.meta.total" :to="researchAreas.meta.to"
            :from="researchAreas.meta.from" />
    </LayoutMain>
</template>
<script setup>
