    ...
    <LayoutMain>
        ...
        <AcademicOfferingForm>
            <template #actions>
                ...
                <BaseButton @click="updateForm" :icon="mdiSend" color="success" label="Actualizar" />
            </template>
        </AcademicOfferingForm>
    </LayoutMain>
</template>
...
const props = defineProps({
    ...
    academicOffering: { type: Object, required: true },
...
const { updateForm, processing } = useAcademicOffering(props);
</script>
