<template>
    <HeadLogo title="Crear oferta laboral" />
    <LayoutMain>
            ...
            <div class="md:flex justify-between items-center md:space-y-0 space-y-2">
                ...
                <div class="flex gap-2 justify-end">
                    ...
                    <BaseButton 
                        :icon="mdiSend" 
                        color="success" 
                        :label="props.jobOffer ? 'Actualizar' : 'Guardar'" 
                        @click="props.jobOffer ? updateForm() : storeForm()" 
                        :loading="processing"
                    />
                </div>
            </div>
...
import { mdiClose, mdiSend, mdiPlus } from '@mdi/js';
...
const { processing, storeForm, updateForm } = useJobOffer(props)
