            ...
            <div class="flex gap-2 items-center py-4">
                ...
                <div>
                    ...
                    <p class=" text-sm font-light text-slate-800 dark:text-slate-300">
                        Taxonomía y sectores del cuerpo académico
                    </p>
                </div>
            </div>
        </template>
